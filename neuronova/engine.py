...
from neuronova.config import (
    SAMPLE_IMAGE_PATH, WINDOW_MS, OSCILLOSCOPE_WINDOW_MS, ANIM_FPS,
    PLOT_UPDATE_INTERVAL_MS, N_NEURONS, N_CHANNELS, DT, INSULT_THRESHOLD,
    INSULT_WORDS, USE_EMBEDDINGS, EMBEDDING_MODEL, ENABLE_LLM_FALLBACK,
    CHATBOT_MODEL_NAME, EMOTIONS, EMOTION_COLORS, EMOTION_PROTOTYPES,
    NORMALIZATION_MAP, RESPONSE_TEMPLATES, POLITE_FIRM_TEMPLATES, GEMINI_API_KEY
)
